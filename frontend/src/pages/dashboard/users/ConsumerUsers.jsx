    ...
    <div className="user-management">
      <div className="user-management-content">
        <div className="user-management-header">
          <h1 className="user-management-title">Consumer User Management</h1>
        </div>
      ...
      <Modal
        ...
        title={selectedUser ? 'Edit Consumer' : 'Add New Consumer'}
      >
