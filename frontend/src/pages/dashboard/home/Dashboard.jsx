...
function Dashboard() {
  ...
  const recentActivities = [
    {
      id: 1,
      text: "John Doe completed Project A",
      time: "2 hours ago",
      user: "John Doe",
      type: "completion",
    },
    {
      id: 2,
      text: "New client onboarded: XYZ Corp",
      time: "4 hours ago",
      user: "Admin",
      type: "client",
    },
    ...
    {
      id: 4,
      text: "Sarah updated Project B documentation",
      time: "8 hours ago",
      user: "Sarah",
      type: "update",
    },
  ...
  const upcomingTasks = [
    {
      id: 1,
      text: "Client meeting with ABC Inc",
      date: "Today, 2:00 PM",
      priority: "high",
    },
    {
      id: 2,
      text: "Project deadline: Website Redesign",
      date: "Tomorrow, 5:00 PM",
      priority: "medium",
    },
    {
      id: 3,
      text: "Team review meeting",
      date: "Wed, 11:00 AM",
      priority: "low",
    },
    {
